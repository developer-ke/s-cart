                    ...
                    <table class="table table-hover box-body text-wrap table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="fied-required editable editable-click" data-name="domain_strict"
                                        data-type="select" data-pk=""
                                        data-source="{{ json_encode(['1' => 'ON', '0' => 'OFF']) }}"
                                        data-url="{{ sc_route_admin('admin_config_global.update') }}"
                                        data-title="{{ sc_language_render('multi_vendor.MultiVendor_domain_strict') }}"
                                        data-value="{{ sc_config_global('domain_strict') }}" data-original-title=""
                                        title=""></a>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"><span class="text-sm">
                                        ...
                                        {{ sc_language_render('multi_vendor.MultiVendor_domain_strict_help') }}
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td>{{ sc_language_render('multi_vendor.MultiVendor_allow_register') }}</td>
                                <td><input class="check-data-config-global" type="checkbox"
                                        name="MultiVendor_allow_register"
                                        {{ sc_config_global('MultiVendor_allow_register') ? 'checked' : '' }}></td>
                            </tr>
                            <tr>
                                <td colspan="2"><span class="text-sm">
                                        <i class="fa fa-info-circle"></i>
                                        {{ sc_language_render('multi_vendor.MultiVendor_allow_register_help') }}
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><input class="check-data-config-global" type="checkbox"
                                        name="MultiVendor_product_auto_approve"
                                        {{ sc_config_global('MultiVendor_product_auto_approve') ? 'checked' : '' }}></td>
                            </tr>
                            <tr>
                                <td colspan="2"><span class="text-sm">
                                        <i class="fa fa-info-circle"></i>
                                        {{ sc_language_render('multi_vendor.MultiVendor_product_auto_approve_help') }}
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td>{{ sc_language_render('multi_vendor.MultiVendor_quick_order') }}</td>
                                <td><input class="check-data-config-global" type="checkbox" name="MultiVendor_quick_order"
                                        {{ sc_config_global('MultiVendor_quick_order') ? 'checked' : '' }}></td>
                            </tr>
                            <tr>
                                <td colspan="2"><span class="text-sm">
                                        <i class="fa fa-info-circle"></i>
                                        {{ sc_language_render('multi_vendor.MultiVendor_quick_order_help') }}
                                    </span>
                                </td>
                            </tr>
                        </tbody>
