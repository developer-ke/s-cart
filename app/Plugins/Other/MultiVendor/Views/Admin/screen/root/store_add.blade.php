                ...
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr-5">
                            <a href="{{ sc_route_admin('admin_MultiVendor.index') }}" class="btn  btn-flat btn-default"
                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal"
                    ...
                    <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <label for="{{ $code }}__title"
                                            class="col-sm-2 col-form-label">{{ sc_language_render('store.title') }} <span
                                    ...
                                    <div
                                        ...
                                        <label for="{{ $code }}__keyword"
                                            class="col-sm-2 col-form-label">{{ sc_language_render('store.keyword') }} <span
                                                class="seo" title="SEO"><i class="fa fa-coffee"
                                                    aria-hidden="true"></i></span></label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                    ...
                                    <div
                                        ...
                                        <label for="{{ $code }}__description"
                                            class="col-sm-2 col-form-label">{{ sc_language_render('store.description') }}
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            @else
                                                <span class="form-text">
                                                    <i class="fa fa-info-circle"></i>
                                                    {{ sc_language_render('admin.max_c', ['max' => 300]) }}
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="text" id="logo" name="logo" value="{{ old('logo') }}"
                                        class="form-control logo" placeholder="" />
                        ...
                        <div class="form-group  row {{ $errors->has('phone') ? ' text-red' : '' }}">
                            <label for="phone"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.phone') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend">
                        ...
                        <div class="form-group  row {{ $errors->has('long_phone') ? ' text-red' : '' }}">
                            <label for="long_phone"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.long_phone') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend">
                                    ...
                                    <input type="text" id="long_phone" name="long_phone"
                                        value="{{ old('long_phone') }}" class="form-control" placeholder="" />
                                </div>
                        ...
                        <div class="form-group  row {{ $errors->has('time_active') ? ' text-red' : '' }}">
                            <label for="time_active"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.time_active') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend">
                                    ...
                                    <input type="text" id="time_active" name="time_active"
                                        value="{{ old('time_active') }}" class="form-control" placeholder="" />
                                </div>
                        ...
                        <div class="form-group  row {{ $errors->has('address') ? ' text-red' : '' }}">
                            <label for="address"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.address') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend">
                        ...
                        <div class="form-group  row {{ $errors->has('office') ? ' text-red' : '' }}">
                            <label for="office"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.office') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend">
                        ...
                        <div class="form-group d-none row {{ $errors->has('warehouse') ? ' text-red' : '' }}">
                            <label for="warehouse"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.warehouse') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend">
                                    ...
                                    <input type="text" id="warehouse" name="warehouse"
                                        value="{{ old('warehouse') }}" class="form-control" placeholder="" />
                                </div>
                        ...
                        <div class="form-group  row {{ $errors->has('email') ? ' text-red' : '' }}">
                            <label for="email"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.email') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend">
                        ...
                        <div class="form-group  row {{ $errors->has('code') ? ' text-red' : '' }}">
                            <label for="code"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.admin.code') }}</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-prepend">
                        ...
                        <div class="form-group d-none row {{ $errors->has('template') ? ' text-red' : '' }}">
                            <label
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.admin.template') }}</label>
                            <div class="col-sm-8">
                                <select class="form-control" name="template">
                                    @foreach ($templates as $key => $name)
                                        <option {{ old('template') == $key ? 'selected' : '' }}
                        ...
                        <div class="form-group row ">
                            <label for="status"
                                class="col-sm-2 col-form-label">{{ sc_language_render('store.admin.status') }}</label>
                            <div class="col-sm-8">
                                <input class="input checkbox" type="checkbox" name="status"
                                    {{ old('status', empty($store['status']) ? 0 : 1) ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
