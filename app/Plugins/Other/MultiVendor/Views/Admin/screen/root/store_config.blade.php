                ...
                <div class="card-tools">
                    <div class="btn-group float-right mr-5">
                        <a href="{{ sc_route_admin('admin_MultiVendor.index') }}" class="btn  btn-flat btn-default"
                            title="List">
                            <i class="fa fa-list"></i><span class="hidden-xs">
                                {{ sc_language_render('admin.back_list') }}</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-primary card-outline card-outline-tabs">
            ...
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="store-info" data-toggle="pill" href="#tab-store-info" role="tab"
                            aria-controls="tab-store-info"
                            aria-selected="true">{{ sc_language_render('store.admin.config_info') }}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-four-tabContent">
                    {{-- Tab infomation --}}
                    <div class="tab-pane fade  fade active show" id="tab-store-info" role="tabpanel"
