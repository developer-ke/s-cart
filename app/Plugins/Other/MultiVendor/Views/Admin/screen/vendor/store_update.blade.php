                    ...
                    <h2 class="card-title">
                        @if (!$store)
                            <p style="color: red"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                                {!! sc_language_render('multi_vendor.update_info_store_msg') !!}</p>
                        @endif
                    </h2>
                </div>
                <!-- /.card-header -->
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="long_phone" name="long_phone"
                                        value="{{ old('long_phone', $store['long_phone'] ?? '') }}" class="form-control"
                                        placeholder="" />
                                </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="time_active" name="time_active"
                                        value="{{ old('time_active', $store['time_active'] ?? '') }}"
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="office" name="office"
                                        value="{{ old('office', $store['office'] ?? '') }}" class="form-control"
                                        placeholder="" />
                                </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="warehouse" name="warehouse"
                                        value="{{ old('warehouse', $store['warehouse'] ?? '') }}" class="form-control"
                                        placeholder="" />
                                </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="code" name="code"
                                            value="{{ old('code', $store['code'] ?? '') }}" class="form-control"
                                            placeholder="" />
                                    </div>
                                    @if ($errors->has('code'))
                                        <span class="form-text">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="template">
                                    @foreach ($templates as $key => $name)
                                        <option {{ old('template', $store['template'] ?? '') == $key ? 'selected' : '' }}
