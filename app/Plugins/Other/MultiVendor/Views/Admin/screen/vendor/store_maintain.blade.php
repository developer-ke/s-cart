                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            @if ($errors->has('descriptions.' . $code . '.maintain_content'))
                                                <span class="form-text">
                                                    ...
                                                    {{ $errors->first('descriptions.' . $code . '.maintain_content') }}
                                                </span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="col-sm-8">
                                            <input id="{{ $code }}__maintain_note" type="text"
                                                class="form-control input-sm"
                                                name="descriptions[{{ $code }}][maintain_note]"
                                                value="{{ old('descriptions.' . $code . '.maintain_note', $descriptions[$code]['maintain_note'] ?? '') }}">
                                            @if ($errors->has('descriptions.' . $code . '.maintain_note'))
                                                <span class="form-text">
                                                    <i class="fa fa-info-circle"></i>
                                                    {{ $errors->first('descriptions.' . $code . '.maintain_note') }}
                                                </span>
                                            @endif
                                        </div>
                                    </div>
