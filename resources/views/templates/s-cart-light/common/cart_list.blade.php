            ...
            <tbody>
                @foreach ($cartItem as $item)
                    ...
                    <tr
                        ...
                        <td>
                            ...
                            <span>
                                <a href="{{ $product->getUrl() }}"
                                    class="row_cart-name">{{ $product->name }}</a><br />
                        ...
                        <td align="center">
                            <a onclick="return swal('{{ sc_route('cart.remove', ['id' => $item->rowId, 'instance' => 'cart']) }}')"
                                title="Remove Item" alt="Remove Item" class="cart_quantity_delete" title="Remove Item"
                                alt="Remove Item" class="cart_quantity_delete" href="javascript:;">
...
@push('scripts')
    <script type="text/javascript">
        const swal = (removeUrl) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = removeUrl; // Redirect to the remove URL
                }
            });
        }
        ...
        // function total(val) {
        //     let amountSpan = document.getElementById("price");
        //     let amountText = amountSpan.innerText.trim();
        //     // Get the text content and remove any leading or trailing spaces
        //     let amountNumber = parseInt(amountText.replace(/\D/g, ''));
        //     document.querySelector('#total').innerText = val * amountNumber;
        // }
    </script>
@endpush
